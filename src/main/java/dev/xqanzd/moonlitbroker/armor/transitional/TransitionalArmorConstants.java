...
public final class TransitionalArmorConstants {
    ...
    public static final float SCAVENGER_GOGGLES_TOUGHNESS = 1.0f;
    ...
    public static final float CAST_IRON_SALLET_DEFENSE = 3.5f;
    public static final float CAST_IRON_SALLET_TOUGHNESS = 1.0f;
    ...
    public static final float SANCTIFIED_HOOD_TOUGHNESS = 1.0f;
    ...
    public static final float WRAPPED_LEGGINGS_DEFENSE = 4.5f;
    public static final float WRAPPED_LEGGINGS_TOUGHNESS = 1.2f;
    ...
    public static final float REINFORCED_GREAVES_TOUGHNESS = 1.5f;
    ...
    public static final float CARGO_PANTS_TOUGHNESS = 1.2f;
    ...
    public static final float PENITENT_BOOTS_TOUGHNESS = 0.8f;
    ...
    public static final int STANDARD_IRON_BOOTS_DEFENSE = 4;
    public static final float STANDARD_IRON_BOOTS_TOUGHNESS = 0.8f;
    ...
    public static final float CUSHION_HIKING_BOOTS_DEFENSE = 3.5f;
    public static final float CUSHION_HIKING_BOOTS_TOUGHNESS = 0.8f;
