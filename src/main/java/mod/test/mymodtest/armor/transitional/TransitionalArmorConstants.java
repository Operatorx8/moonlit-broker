...
public final class TransitionalArmorConstants {
    ...
    public static final int SCAVENGER_GOGGLES_DEFENSE = 2;
    public static final float SCAVENGER_GOGGLES_TOUGHNESS = 0.0f;
    ...
    public static final int CAST_IRON_SALLET_DEFENSE = 2;
    public static final float CAST_IRON_SALLET_TOUGHNESS = 0.5f;
    ...
    public static final int SANCTIFIED_HOOD_DEFENSE = 1;
    public static final float SANCTIFIED_HOOD_TOUGHNESS = 0.0f;
    ...
    public static final int REACTIVE_BUG_PLATE_DEFENSE = 6;
    public static final float REACTIVE_BUG_PLATE_TOUGHNESS = 1.0f;
    ...
    public static final int PATCHWORK_COAT_DEFENSE = 5;
    public static final float PATCHWORK_COAT_TOUGHNESS = 0.0f;
    public static final Rarity PATCHWORK_COAT_RARITY = Rarity.UNCOMMON;

    // === 6. Ritual Robe - 仪式罩袍 ===
    public static final int RITUAL_ROBE_DURABILITY = 220;
    public static final int RITUAL_ROBE_DEFENSE = 5;
    public static final float RITUAL_ROBE_TOUGHNESS = 1.0f;
    ...
    public static final int WRAPPED_LEGGINGS_DEFENSE = 4;
    public static final float WRAPPED_LEGGINGS_TOUGHNESS = 0.5f;
    ...
    public static final float REINFORCED_GREAVES_TOUGHNESS = 0.5f;
    public static final Rarity REINFORCED_GREAVES_RARITY = Rarity.UNCOMMON;

    // === 9. Cargo Pants - 多袋工装裤 ===
    public static final int CARGO_PANTS_DURABILITY = 225;
    public static final int CARGO_PANTS_DEFENSE = 5;
    public static final float CARGO_PANTS_TOUGHNESS = 0.0f;
    ...
    public static final float PENITENT_BOOTS_TOUGHNESS = 0.5f;
    ...
    public static final int STANDARD_IRON_BOOTS_DEFENSE = 2;
    public static final float STANDARD_IRON_BOOTS_TOUGHNESS = 0.5f;
    ...
    public static final float CUSHION_HIKING_BOOTS_TOUGHNESS = 0.5f;
