...
import dev.xqanzd.moonlitbroker.armor.effect.VoidDevourerHandler;
...
public class PlayerAttackMixin {
    ...
    private boolean armor$redirectDamage(Entity target, DamageSource source, float amount) {
        ...
        if (bootsState.marchActive
            ...
            long exitCdUntil = currentTick + dev.xqanzd.moonlitbroker.armor.BootsEffectConstants.MARCH_CD_TICKS;
            org.slf4j.LoggerFactory.getLogger(ModLog.MOD_TAG).info(
                    ...
                    currentTick,
                    bootsState.marchStartTick + dev.xqanzd.moonlitbroker.armor.BootsEffectConstants.MARCH_MAX_DURATION_TICKS,
                    exitCdUntil
            );
